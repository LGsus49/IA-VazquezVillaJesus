...
# Dibujar círculos amarillos con etiquetas
for idx, center in enumerate(object_centers):
    cv2.circle(image, center=center, radius=5, color=(0, 255, 255), thickness=2)
    cv2.putText(image, f"{idx+1}", (center[0]+10, center[1]), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1)

# Guardar y mostrar la imagen resultante
output_image_path = 'objetosrojos_etiquetados.jpg'
